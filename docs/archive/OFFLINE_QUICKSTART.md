...
:: 解压到 tts_model 目录
tar -xvf xtts_v2.tar -C ..\..\..\tts_model
...
1. 下载 Python 3.10.11: https://www.python.org/ftp/python/3.10.11/python-3.10.11-amd64.exe
2. 双击运行
...
1. 下载 VS Build Tools: https://aka.ms/vs/17/release/vs_buildtools.exe
2. 双击运行
3. 等待加载（需要网络下载组件列表）
...
2. 解压后将 `ffmpeg.exe`, `ffprobe.exe`, `ffplay.exe` 复制到项目根目录
3. 或者添加到系统 PATH
